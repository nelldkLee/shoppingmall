...
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:400,700">
    ...
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath }/assets/admin/css/fontawesome.min.css">
    <!-- https://fontawesome.com/ -->
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath }/assets/admin/css/bootstrap.min.css">
