package com.cafe24.front.shoppingmall.config.app;
...
import com.cafe24.front.shoppingmall.security.CustomUrlAuthenticationSuccessHandler;
...
public class AppSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
				...
				// FormLoginConfigurer
				.and().formLogin().loginPage("/member/login").loginProcessingUrl("/member/auth")
				.failureUrl("/member/login").successHandler(authenticationSuccessHandler()).usernameParameter("email")
				...
				.and().exceptionHandling().accessDeniedPage("/views/error/404.jsp")

				// RememberMeConfigurer
				.and().rememberMe().key("mysite").rememberMeParameter("remember-me")
